...
$targetWindowsDir = "W:\"            # The mapping path to the share that will contain the disk and its hash. By default the scripts assume you mounted the Azure file share on drive Z.
...
if ($bios) {   
	...
	Write-Output "Getting a list of existing drives"
	Get-PSDrive
    ...
    # Mount the drive
    New-PSDrive -Name W -PSProvider FileSystem -Root "\\stfrsclabdev.file.core.windows.net\workershare" -Persist
	} else {
